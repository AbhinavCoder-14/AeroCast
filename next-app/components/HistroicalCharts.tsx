...
interface YearlyDataPoint {
  ...
  const yearlyData: YearlyDataPoint[] = Array.from({length:12}, (_, i): YearlyDataPoint => {
    ...
    return {
      ...
      wind_speed_10m_max:30+Math.random()*10,
      precipitation_sum:40+Math.random()*40
        ...
        <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white/10 backdrop-blur-2xl rounded-3xl p-8 border border-white/20 shadow-2xl">
                <h3 className="text-2xl font-bold mb-6">Wind Speed</h3>
                <div className="h-64">
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    <LineChart data={yearlyData}>
                      ...
                      />
                      <Line type="monotone" dataKey="wind_speed_10m_max" stroke="#8B5CF6" strokeWidth={3} />
                    </LineChart>
              ...
              <div className="bg-white/10 backdrop-blur-2xl rounded-3xl p-8 border border-white/20 shadow-2xl">
                <h3 className="text-2xl font-bold mb-6">Precipitation</h3>
                <div className="h-64">
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    <LineChart data={yearlyData}>
                      ...
                      />
                      <Line type="monotone" dataKey="precipitation_sum" stroke="#8B5CF6" strokeWidth={3} />
                    </LineChart>
